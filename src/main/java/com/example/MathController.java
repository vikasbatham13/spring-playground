...
public class MathController {
    ...
    public String calculateNumbers(@RequestParam Map<String, String> querystring) {
        ...
        response = MathService.calculation(var1, var2, operation);
    ...
    public String sumNumbers(@RequestParam MultiValueMap querystring) {
        ...
        for (String key : keys) {
            ...
            for (Object temp : list) {
                ...
                sum = MathService.calculation(sum, val2, "add");
            }
        }
    ...
    public static class MathService {
        public static int calculation(int var1, int var2, String operation) {
            int response = 0;
